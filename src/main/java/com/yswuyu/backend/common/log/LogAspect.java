package com.yswuyu.backend.common.log;
...
import com.yswuyu.backend.service.SysOperLogService;
import com.yswuyu.backend.shiro.util.ShiroUtils;
import com.yswuyu.backend.util.ServletUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yswuyu.backend.common.log.Log)")
