package com.yswuyu.backend.common.file;
...
import com.yswuyu.backend.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 是否上传到static
     */
    private static String isstatic=BaseConfig.getIsstatic();
	...
	public static String getRoot_dir() {
		String url=ClassUtils.getDefaultClassLoader().getResource("").getPath()+BaseConfig.getIsroot_dir();
		return url;
	}
