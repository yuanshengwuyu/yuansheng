package com.yswuyu.backend.model.custom.autocode;
...
/*            表关系配置
    ...
    /**
     * 生成代码的父包 如父包是com.yswuyu.backend  controller将在com.yswuyu.backend.controller下 bean 将在com.yswuyu.backend.bean下 ,service,dao同理
     */
