...
import com.yswuyu.backend.mapper.auto.SysNoticeMapper;
import com.yswuyu.backend.mapper.auto.SysNoticeUserMapper;
...
import com.yswuyu.backend.model.auto.SysNoticeUserExample.Criteria;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.yswuyu.backend.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
