...
import com.yswuyu.backend.model.auto.TSysEmail;
import com.yswuyu.backend.model.custom.email.MailSenderInfo;
import com.yswuyu.backend.model.custom.email.MyAuthenticator;
...
public class SimpleEmailUtil {
	...
	public static void sendEmail(TSysEmail tSysEmail) throws Exception {
		...
		mailInfo.setMailServerHost(BaseConfig.getEmail_smtp());
		mailInfo.setMailServerPort(BaseConfig.getEmail_port());
		mailInfo.setValidate(true);
		mailInfo.setSsl(true);
		mailInfo.setUserName(BaseConfig.getEmail_account());
		mailInfo.setPassword(BaseConfig.getEmail_password());// 您的邮箱密码
